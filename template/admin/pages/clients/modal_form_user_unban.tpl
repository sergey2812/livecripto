...
$(function()
{
    ...
    $('#banned_modal_form_2').modal({
    keyboard: true,
    backdrop: 'static',
   })

    let hidden_rows = $('input[name="btn_open"]').val();
    ...
    if (hidden_rows == 1)
    ...
    else
        {
            ...
            $('.mod_title').text("Разблокировать клиента");
            $('input[name="btn_open"]').val('');
        }
...
<div id="banned_modal_form_2" class="modal fadeIn" aria-hidden="true" data-method="fade" data-amination-time="700">
    <form action="" method="POST">
<div class="modal-content ban-unban">
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
    <div class="mod_title">Разблокировать клиента</div> 
            ...
            <div class="col-xs-12">
                ...
                <div class="form-row">
                    <form class="modal_form_banned_button" method="POST">
                        <input type="hidden" name="function" value="unban">
                        ...
                        <button name="modal_banned_btn" type="submit" class="btn btn-primary ban-unban">Разблокировать</button>
                    </form>
                </div>                
            </div>
            </div>
