...
$ajax = new \LiveinCrypto\Ajax();
    ...
    if (isset($_POST["id_country"]) AND isset($_POST["id_city"]) AND isset($_POST["active_section_id"]) AND isset($_POST["active_category_id"]) AND isset($_POST["active_subcategory_id"]))
        {
            ...
            $result = $update_prices->GetUpdatePrices($params);
